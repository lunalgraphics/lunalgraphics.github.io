import{S as wn,i as _n,s as Rn,n as kn,d as m,p as Bn,q as En,r as In,b as q,c as n,u as Ln,e as s,v as M,C as Y,f as a,k as d,j as r,g as Kt,h as i,w as An,x as Mn,l,m as o,t as p,y as Dn}from"../chunks/Bnk2KS7n.js";import"../chunks/IHki7fMi.js";import{b as Tn}from"../chunks/4GzgVfVL.js";import{b as xn}from"../chunks/CATdmPBR.js";import{S as Gn}from"../chunks/Bb_zkeU2.js";const On=""+new URL("../assets/step1.2b_17yWx.png",import.meta.url).href,Un=""+new URL("../assets/step2.CiY_EIS-.png",import.meta.url).href,jn=""+new URL("../assets/step3.RMUM8rKu.png",import.meta.url).href,Hn=""+new URL("../assets/step4.DAR7kCj5.png",import.meta.url).href,Pn=""+new URL("../assets/step5.CVHOeoia.png",import.meta.url).href,Yn=""+new URL("../assets/step6.BWb0zP84.png",import.meta.url).href;function Sn(vn){let c,Vt=`<div class="centered"><h1>Installing/Deleting .deb Packages on Linux</h1> <p>Download your favorite desktop apps<br/>
            Blog Entry 3<br/>
    ...
    REAL_PACKAGE_NAME`,Lt,E,At,bn="[Y/n]",Mt,Dt,I,fn="y",Tt,Gt,Ot,Ut,jt,Ht,Pt,P,gn="If you liked this article, feel free to share it on social media!",Yt,St,Ft,Nt,$t,L,yn="Back to the blog",F,A,N;return A=new Gn({props:{title:"Installing/Deleting .deb Packages on Linux | Blog | Lunal Graphics",desc:"Download your favorite desktop apps on Linux.",imgURL:xn,pageURL:"https://lunalgraphics.com",imgAlt:"Installing a deb package on Ubuntu"}}),{c(){c=l("div"),c.innerHTML=Vt,S=o(),e=l("div"),K=p(`If you're trying to download Linux apps from the web, such as Lunal Graphics
    ...
    simple steps.
    `),V=l("br"),z=o(),W=l("br"),J=o(),b=l("a"),b.textContent=zt,Q=p(` |
    `),f=l("a"),f.textContent=Wt,X=o(),Z=l("br"),ee=o(),te=l("br"),ne=o(),g=l("h1"),g.textContent=Jt,ae=o(),le=l("br"),re=o(),D=l("h2"),D.textContent=Qt,oe=o(),se=l("br"),ie=o(),y=l("img"),pe=o(),de=l("br"),he=p(`
    ...
    `),ce=l("br"),ue=o(),me=l("br"),be=o(),fe=l("br"),ge=o(),T=l("h2"),T.textContent=Zt,ye=o(),Ce=l("br"),xe=o(),C=l("img"),ve=o(),we=l("br"),_e=p(`
    Once you've found the file, right click its thumbnail and press `),G=l("b"),G.textContent=tn,Re=p(`.
    ...
    `),ke=l("br"),Be=o(),Ee=l("br"),Ie=o(),Le=l("br"),Ae=o(),O=l("h2"),O.textContent=nn,Me=o(),De=l("br"),Te=o(),x=l("img"),Ge=o(),Oe=l("br"),Ue=p(`
    Make sure your Files app is still opened to the folder containing the .deb file.
    Click the three dots next to the searchbar and press `),U=l("b"),U.textContent=ln,je=p(`.
    ...
    `),He=l("br"),Pe=o(),Ye=l("br"),Se=o(),Fe=l("br"),Ne=o(),j=l("h2"),j.textContent=rn,$e=o(),qe=l("br"),Ke=o(),v=l("img"),Ve=o(),ze=l("br"),We=p(`
    In the command line, type `),w=l("code"),w.textContent=sn,Je=p(`,
    ...
    `),Qe=l("br"),Xe=o(),Ze=l("br"),et=o(),tt=l("br"),nt=o(),H=l("h2"),H.textContent=pn,at=o(),lt=l("br"),rt=o(),_=l("img"),ot=o(),st=l("br"),it=p(`
    ...
    saying `),R=l("code"),R.textContent=hn,pt=p(`.
    Copy that REAL_PACKAGE_NAME and make sure to write it down somewhere, in case you need
    to delete the package at any time. `),dt=l("br"),ht=o(),ct=l("br"),ut=p(` Your new app should appear in your computer's Applications menu.
    `),mt=l("br"),bt=o(),ft=l("br"),gt=o(),yt=l("br"),Ct=o(),u=l("h1"),xt=p("Uninstalling "),vt=p(cn),wt=p(" a .deb package"),_t=o(),Rt=l("br"),kt=o(),k=l("img"),Bt=o(),Et=l("br"),It=p(`
    Remember when I had you copy the real package name of the .deb? You can use it to
    uninstall the package. Simply open your Terminal app, type `),B=l("code"),B.textContent=mn,Lt=p(`, and hit Enter. You may need to type in your password and hit
    Enter again. The command prompt will ask `),E=l("code"),At=p("Do you want to continue? "),Mt=p(bn),Dt=p(`
    Type in `),I=l("code"),I.textContent=fn,Tt=p(` and press Enter.
    `),Gt=l("br"),Ot=o(),Ut=l("br"),jt=o(),Ht=l("br"),Pt=o(),P=l("i"),P.textContent=gn,Yt=o(),St=l("br"),Ft=o(),Nt=l("br"),$t=o(),L=l("a"),L.textContent=yn,F=o(),Dn(A.$$.fragment),this.h()},l(h){c=a(h,"DIV",{class:!0,style:!0,"data-svelte-h":!0}),d(c)!=="svelte-11zqms9"&&(c.innerHTML=Vt),S=r(h),e=a(h,"DIV",{class:!0});var t=Kt(e);K=i(t,`If you're trying to download Linux apps from the web, such as Lunal Graphics
    products, .deb packages are probably the best file format to work with. They
    contain all of the app's assets, and you can extract them for usage in a few
    simple steps.
    `),V=a(t,"BR",{}),z=r(t),W=a(t,"BR",{}),J=r(t),b=a(t,"A",{href:!0,"data-svelte-h":!0}),d(b)!=="svelte-1ey43kx"&&(b.textContent=zt),Q=i(t,` |
    ...
    Once you've downloaded the .deb file, locate it in your Files app. If you downloaded
    the file from a web browser, it probably went to the Downloads folder.
    `),ce=a(t,"BR",{}),ue=r(t),me=a(t,"BR",{}),be=r(t),fe=a(t,"BR",{}),ge=r(t),T=a(t,"H2",{"data-svelte-h":!0}),d(T)!=="svelte-1ipm5i8"&&(T.textContent=Zt),ye=r(t),Ce=a(t,"BR",{}),xe=r(t),C=a(t,"IMG",{src:!0,alt:!0}),ve=r(t),we=a(t,"BR",{}),_e=i(t,`
    Once you've found the file, right click its thumbnail and press `),G=a(t,"B",{"data-svelte-h":!0}),d(G)!=="svelte-mkcykb"&&(G.textContent=tn),Re=i(t,`.
    This will open up some additional information including the name of the file. Select
    the filename and copy it with Ctrl + C. Make sure you've copied the entire filename,
    including the .deb file extension.
    `),ke=a(t,"BR",{}),Be=r(t),Ee=a(t,"BR",{}),Ie=r(t),Le=a(t,"BR",{}),Ae=r(t),O=a(t,"H2",{"data-svelte-h":!0}),d(O)!=="svelte-1rpz6rj"&&(O.textContent=nn),Me=r(t),De=a(t,"BR",{}),Te=r(t),x=a(t,"IMG",{src:!0,alt:!0}),Ge=r(t),Oe=a(t,"BR",{}),Ue=i(t,`
    Make sure your Files app is still opened to the folder containing the .deb file.
    Click the three dots next to the searchbar and press `),U=a(t,"B",{"data-svelte-h":!0}),d(U)!=="svelte-12b4tn"&&(U.textContent=ln),je=i(t,`.
    This will open your computer's command line app. You will see the folder's path
    next to the prompt, meaning that the command line is opened within a specific folder.
    `),He=a(t,"BR",{}),Pe=r(t),Ye=a(t,"BR",{}),Se=r(t),Fe=a(t,"BR",{}),Ne=r(t),j=a(t,"H2",{"data-svelte-h":!0}),d(j)!=="svelte-14sbxkj"&&(j.textContent=rn),$e=r(t),qe=a(t,"BR",{}),Ke=r(t),v=a(t,"IMG",{src:!0,alt:!0}),Ve=r(t),ze=a(t,"BR",{}),We=i(t,`
    In the command line, type `),w=a(t,"CODE",{class:!0,"data-svelte-h":!0}),d(w)!=="svelte-zfnrg0"&&(w.textContent=sn),Je=i(t,`,
    then use Ctrl + Shift + V to paste the name of the .deb file. Hit Enter to install
    the application. You may need to type your password and press Enter again.
    `),Qe=a(t,"BR",{}),Xe=r(t),Ze=a(t,"BR",{}),et=r(t),tt=a(t,"BR",{}),nt=r(t),H=a(t,"H2",{"data-svelte-h":!0}),d(H)!=="svelte-311at8"&&(H.textContent=pn),at=r(t),lt=a(t,"BR",{}),rt=r(t),_=a(t,"IMG",{src:!0,alt:!0}),ot=r(t),st=a(t,"BR",{}),it=i(t,`
    The filename of the .deb package may be different from the actual package name.
    When you use the installation command, the real package name will appear in a message
    saying `),R=a(t,"CODE",{class:!0,"data-svelte-h":!0}),d(R)!=="svelte-3cov6e"&&(R.textContent=hn),pt=i(t,`.
    Copy that REAL_PACKAGE_NAME and make sure to write it down somewhere, in case you need
    to delete the package at any time. `),dt=a(t,"BR",{}),ht=r(t),ct=a(t,"BR",{}),ut=i(t,` Your new app should appear in your computer's Applications menu.
    `),mt=a(t,"BR",{}),bt=r(t),ft=a(t,"BR",{}),gt=r(t),yt=a(t,"BR",{}),Ct=r(t),u=a(t,"H1",{id:!0});var $=Kt(u);xt=i($,"Uninstalling "),vt=i($,cn),wt=i($," a .deb package"),$.forEach(m),_t=r(t),Rt=a(t,"BR",{}),kt=r(t),k=a(t,"IMG",{src:!0,alt:!0}),Bt=r(t),Et=a(t,"BR",{}),It=i(t,`
    Remember when I had you copy the real package name of the .deb? You can use it to
    uninstall the package. Simply open your Terminal app, type `),B=a(t,"CODE",{class:!0,"data-svelte-h":!0}),d(B)!=="svelte-bb0e1k"&&(B.textContent=mn),Lt=i(t,`, and hit Enter. You may need to type in your password and hit
    Enter again. The command prompt will ask `),E=a(t,"CODE",{class:!0});var qt=Kt(E);At=i(qt,"Do you want to continue? "),Mt=i(qt,bn),qt.forEach(m),Dt=i(t,`
    Type in `),I=a(t,"CODE",{class:!0,"data-svelte-h":!0}),d(I)!=="svelte-rbmw5f"&&(I.textContent=fn),Tt=i(t,` and press Enter.
